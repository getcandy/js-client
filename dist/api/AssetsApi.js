...
export default class AssetsApi {
  ...
  */
  ...
  postAssets(opts) {
    return this.postAssetsWithHttpInfo(opts).then(function (response_and_data) {
  ...
  postAssetsAssetIdDetachOwnerIdWithHttpInfo(assetId, ownerId, opts) {
    opts = opts || {};
    let postBody = opts['assetDetachBody']; // verify the required parameter 'assetId' is set
    ...
    let accepts = [];
    let returnType = null;
    return this.apiClient.callApi('/assets/{assetId}/detach/{ownerId}', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Detach an asset from it's model
   * Detaches any assets from a given model. Useful if you want to remove certain assets from a product (or another model) without deleting the asset itself.
  ...
  postAssetsAssetIdDetachOwnerId(assetId, ownerId, opts) {
    return this.postAssetsAssetIdDetachOwnerIdWithHttpInfo(assetId, ownerId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postAssetsSimpleWithHttpInfo(file) {
    let postBody = null; // verify the required parameter 'file' is set
    ...
    return this.apiClient.callApi('/assets/simple', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Simple asset upload
   * This endpoint allows you to upload an asset without having to attach it to a model. This is good for one time uploads where you just want to get back a URL
  ...
  postAssetsSimple(file) {
    return this.postAssetsSimpleWithHttpInfo(file).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putAssetsWithHttpInfo(opts) {
    ...
    let accepts = ['application/json'];
    let returnType = AssetResponse;
    return this.apiClient.callApi('/assets', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update Assets
   * Update all assets in the given array of ids.
  ...
  putAssets(opts) {
    return this.putAssetsWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

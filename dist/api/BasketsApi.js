...
export default class BasketsApi {
  ...
  */
  ...
  deleteBasketLinesWithHttpInfo() {
    ...
    return this.apiClient.callApi('/basket-lines', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Delete basket lines
   * Removes basket lines from a basket
  ...
  deleteBasketLines() {
    return this.deleteBasketLinesWithHttpInfo().then(function (response_and_data) {
  ...
  deleteBasketsBasketIdWithHttpInfo(basketId) {
    ...
    let accepts = [];
    let returnType = null;
    return this.apiClient.callApi('/baskets/{basketId}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Delete a basket by ID
   * Deletes a basket
  ...
  deleteBasketsBasketId(basketId) {
    return this.deleteBasketsBasketIdWithHttpInfo(basketId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  deleteBasketsBasketIdDiscountsWithHttpInfo(basketId) {
    ...
    let accepts = [];
    let returnType = null;
    return this.apiClient.callApi('/baskets/{basketId}/discounts', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Remove discount
   * Allows a user/guest to remove a basket from their basket. Useful if you can only have one discount at a time and they wish to use a different one. 
  ...
  deleteBasketsBasketIdDiscounts(basketId) {
    return this.deleteBasketsBasketIdDiscountsWithHttpInfo(basketId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  deleteBasketsBasketIdUserWithHttpInfo(basketId) {
    ...
    let accepts = ['application/json'];
    let returnType = InlineResponse2007;
    return this.apiClient.callApi('/baskets/{basketId}/user', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Remove user
   * Removes a user from a basket and turns it into a guest basket  > This endpoint will be deprecated in 0.3.0
  ...
  deleteBasketsBasketIdUser(basketId) {
    return this.deleteBasketsBasketIdUserWithHttpInfo(basketId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getBasketsWithHttpInfo() {
    ...
    return this.apiClient.callApi('/baskets', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get baskets
   * Get a paginated list of baskets
  ...
  getBaskets() {
    return this.getBasketsWithHttpInfo().then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getBasketsBasketIdWithHttpInfo(basketId) {
    ...
    return this.apiClient.callApi('/baskets/{basketId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get basket
   * Get a basket by it's ID
  ...
  getBasketsBasketId(basketId) {
    return this.getBasketsBasketIdWithHttpInfo(basketId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getBasketsCurrentWithHttpInfo() {
    ...
    let accepts = ['application/json'];
    let returnType = BasketResponse;
    return this.apiClient.callApi('/baskets/current', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get the current basket for a user
   * This request will get the current active basket for a user
  ...
  getBasketsCurrent() {
    return this.getBasketsCurrentWithHttpInfo().then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getBasketsSavedWithHttpInfo() {
    ...
    return this.apiClient.callApi('/baskets/saved', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get a users saved baskets
   * Returns an authenticatd users saved baskets.
  ...
  getBasketsSaved() {
    return this.getBasketsSavedWithHttpInfo().then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postBasketLinesWithHttpInfo(opts) {
    ...
    let accepts = ['application/json'];
    let returnType = BasketResponse;
    return this.apiClient.callApi('/basket-lines', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Create basket lines
   * Add lines to a basket
  ...
  postBasketLines(opts) {
    return this.postBasketLinesWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postBasketsWithHttpInfo(opts) {
    ...
    let accepts = ['application/json'];
    let returnType = BasketResponse;
    return this.apiClient.callApi('/baskets', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Create Basket
   * @param {Object} opts Optional parameters
  ...
  postBasketsBasketIdClaimWithHttpInfo(basketId) {
    ...
    let accepts = ['application/json'];
    let returnType = BasketResponse;
    return this.apiClient.callApi('/baskets/{basketId}/claim', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Allow a user to claim a basket
   * A user is able to \"claim\" a guest basket. 
  ...
  postBasketsBasketIdClaim(basketId) {
    return this.postBasketsBasketIdClaimWithHttpInfo(basketId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postBasketsBasketIdMetaWithHttpInfo(basketId, opts) {
    opts = opts || {};
    let postBody = opts['addBasketMetaBody']; // verify the required parameter 'basketId' is set
    ...
    return this.apiClient.callApi('/baskets/{basketId}/meta', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Add meta information
   * Allows you to add custom meta information to a basket.
  ...
  postBasketsBasketIdMeta(basketId, opts) {
    return this.postBasketsBasketIdMetaWithHttpInfo(basketId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postBasketsBasketIdSaveWithHttpInfo(basketId, opts) {
    opts = opts || {};
    let postBody = opts['saveBasketBody']; // verify the required parameter 'basketId' is set
    ...
    let accepts = ['application/json'];
    let returnType = BasketResponse;
    return this.apiClient.callApi('/baskets/{basketId}/save', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Save a basket for a user
   * Saves a basket to a users account.
  ...
  postBasketsBasketIdSave(basketId, opts) {
    return this.postBasketsBasketIdSaveWithHttpInfo(basketId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postBasketsResolveWithHttpInfo(opts) {
    ...
    let accepts = ['application/json'];
    let returnType = BasketResponse;
    return this.apiClient.callApi('/baskets/resolve', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Resolve a basket
   * This endpoint is for when you want to either merge a users basket with a guest basket and then assign that new basket or associate a user to a guest basket.  If you choose not to merge a basket, their current one will be overwritten with the guest basket.
  ...
  postBasketsResolve(opts) {
    return this.postBasketsResolveWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putBasketLinesBasketLineIdWithHttpInfo(basketLineId, opts) {
    opts = opts || {};
    let postBody = opts['basketLineUpdateBody']; // verify the required parameter 'basketLineId' is set
    ...
    let accepts = ['application/json'];
    let returnType = BasketResponse;
    return this.apiClient.callApi('/basket-lines/{basketLineId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update basket line
   * Update a basket line based on it's ID.
  ...
  putBasketLinesBasketLineId(basketLineId, opts) {
    return this.putBasketLinesBasketLineIdWithHttpInfo(basketLineId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putBasketLinesBasketLineIdAddWithHttpInfo(basketLineId, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = BasketResponse;
    return this.apiClient.callApi('/basket-lines/{basketLineId}/add', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update basket line quantity
   * Update basket line quantity
  ...
  putBasketLinesBasketLineIdAdd(basketLineId, opts) {
    return this.putBasketLinesBasketLineIdAddWithHttpInfo(basketLineId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putBasketLinesBasketLineIdRemoveWithHttpInfo(basketLineId, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = BasketResponse;
    return this.apiClient.callApi('/basket-lines/{basketLineId}/remove', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Remove basket line quantity
   * Removes quantity from a basket line
  ...
  putBasketLinesBasketLineIdRemove(basketLineId, opts) {
    return this.putBasketLinesBasketLineIdRemoveWithHttpInfo(basketLineId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putBasketsBasketIdWithHttpInfo(basketId) {
    ...
    let accepts = ['application/json'];
    let returnType = BasketResponse;
    return this.apiClient.callApi('/baskets/{basketId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update a basket by ID
   * Updates a basket
  ...
  putBasketsBasketId(basketId) {
    return this.putBasketsBasketIdWithHttpInfo(basketId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putBasketsBasketIdUserWithHttpInfo(basketId) {
    ...
    let accepts = ['application/json'];
    let returnType = Basket;
    return this.apiClient.callApi('/baskets/{basketId}/user', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Add user
   * Attach a user to a basket.  > This endpoint will be deprecated in version 0.3.0
  ...
  putBasketsBasketIdUser(basketId) {
    return this.putBasketsBasketIdUserWithHttpInfo(basketId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putBasketsSavedBasketIdWithHttpInfo(basketId, opts) {
    ...
    return this.apiClient.callApi('/baskets/saved/{basketId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update a saved basket
   * Updates a saved basket on the API
  ...
  putBasketsSavedBasketId(basketId, opts) {
    return this.putBasketsSavedBasketIdWithHttpInfo(basketId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

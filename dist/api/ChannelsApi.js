...
export default class ChannelsApi {
  ...
  */
  ...
  deleteChannelsChannelIdWithHttpInfo(channelId) {
    let postBody = null; // verify the required parameter 'channelId' is set
    ...
    let accepts = [];
    let returnType = null;
    return this.apiClient.callApi('/channels/{channelId}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Delete the channel resource
   * @param {String} channelId 
  ...
  deleteChannelsChannelId(channelId) {
    return this.deleteChannelsChannelIdWithHttpInfo(channelId).then(function (response_and_data) {
  ...
  getChannels(opts) {
    return this.getChannelsWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getChannelsChannelIdWithHttpInfo(channelId, opts) {
    ...
    return this.apiClient.callApi('/channels/{channelId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get the channel resource
   * @param {String} channelId 
  ...
  getChannelsChannelId(channelId, opts) {
    return this.getChannelsChannelIdWithHttpInfo(channelId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postChannels(opts) {
    return this.postChannelsWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putChannelsChannelIdWithHttpInfo(channelId) {
    ...
    let accepts = ['application/json'];
    let returnType = ChannelResponse;
    return this.apiClient.callApi('/channels/{channelId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update the channel resource
   * @param {String} channelId 
  ...
  putChannelsChannelId(channelId) {
    return this.putChannelsChannelIdWithHttpInfo(channelId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

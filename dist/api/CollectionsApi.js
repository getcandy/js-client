...
export default class CollectionsApi {
  ...
  */
  ...
  deleteCollectionsCollectionIdWithHttpInfo(collectionId) {
    let postBody = null; // verify the required parameter 'collectionId' is set
    ...
    let accepts = [];
    let returnType = null;
    return this.apiClient.callApi('/collections/{collectionId}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Delete Collection
   * Delete a Collection by its ID
  ...
  deleteCollectionsCollectionId(collectionId) {
    return this.deleteCollectionsCollectionIdWithHttpInfo(collectionId).then(function (response_and_data) {
  ...
  getCollections(opts) {
    return this.getCollectionsWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getCollectionsCollectionIdWithHttpInfo(collectionId, opts) {
    ...
    return this.apiClient.callApi('/collections/{collectionId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Single Collection
   * Get a single Collection by its ID
  ...
  getCollectionsCollectionId(collectionId, opts) {
    return this.getCollectionsCollectionIdWithHttpInfo(collectionId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postCollections(opts) {
    return this.postCollectionsWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postCollectionsCollectionIdProductsWithHttpInfo(collectionId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject5']; // verify the required parameter 'collectionId' is set
    ...
    return this.apiClient.callApi('/collections/{collectionId}/products', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update a collection's products
   * Syncs products with a collection.
  ...
  postCollectionsCollectionIdProducts(collectionId, opts) {
    return this.postCollectionsCollectionIdProductsWithHttpInfo(collectionId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postCollectionsCollectionRoutesWithHttpInfo(collectionId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject4']; // verify the required parameter 'collectionId' is set
    ...
    let accepts = ['application/json'];
    let returnType = CategoryResponse;
    return this.apiClient.callApi('/collections/{collectionId}/routes', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update a collection's routes
   * This request will allow you to attach routes to a collection
  ...
  postCollectionsCollectionRoutes(collectionId, opts) {
    return this.postCollectionsCollectionRoutesWithHttpInfo(collectionId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putCollectionsCollectionIdWithHttpInfo(collectionId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject7']; // verify the required parameter 'collectionId' is set
    ...
    let accepts = ['application/json'];
    let returnType = CollectionResponse;
    return this.apiClient.callApi('/collections/{collectionId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update Collection
   * Update a Collection by its ID.
  ...
  putCollectionsCollectionId(collectionId, opts) {
    return this.putCollectionsCollectionIdWithHttpInfo(collectionId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

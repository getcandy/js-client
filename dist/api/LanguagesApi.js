...
export default class LanguagesApi {
  ...
  */
  ...
  deleteLanguagesLanguageIdWithHttpInfo(languageId) {
    let postBody = null; // verify the required parameter 'languageId' is set
    ...
    let returnType = null;
    return this.apiClient.callApi('/languages/{languageId}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Delete Language
   * Delete a Language by its ID
  ...
  deleteLanguagesLanguageId(languageId) {
    return this.deleteLanguagesLanguageIdWithHttpInfo(languageId).then(function (response_and_data) {
  ...
  getLanguagesLanguageIdWithHttpInfo(languageId) {
    ...
    return this.apiClient.callApi('/languages/{languageId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get Language
   * Get a Language by ID
  ...
  getLanguagesLanguageId(languageId) {
    return this.getLanguagesLanguageIdWithHttpInfo(languageId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postLanguagesWithHttpInfo(opts) {
    ...
    let accepts = ['application/json'];
    let returnType = LanguageResponse;
    return this.apiClient.callApi('/languages', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Create Language
   * Create a new language
  ...
  postLanguages(opts) {
    return this.postLanguagesWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putLanguagesLanguageIdWithHttpInfo(languageId, opts) {
    opts = opts || {};
    let postBody = opts['language']; // verify the required parameter 'languageId' is set
    ...
    let accepts = ['application/json'];
    let returnType = LanguageResponse;
    return this.apiClient.callApi('/languages/{languageId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update Language
   * Update a Language using it's ID
  ...
  putLanguagesLanguageId(languageId, opts) {
    return this.putLanguagesLanguageIdWithHttpInfo(languageId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

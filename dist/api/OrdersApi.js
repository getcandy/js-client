...
export default class OrdersApi {
  ...
  */
  ...
  deleteOrdersLinesOrderIdWithHttpInfo(orderLineId) {
    let postBody = null; // verify the required parameter 'orderLineId' is set
    ...
    let accepts = [];
    let returnType = null;
    return this.apiClient.callApi('/orders/lines/{orderLineId}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Delete an order line
   * Deletes an order line from an order
  ...
  deleteOrdersLinesOrderId(orderLineId) {
    return this.deleteOrdersLinesOrderIdWithHttpInfo(orderLineId).then(function (response_and_data) {
  ...
  getOrders(opts) {
    return this.getOrdersWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getOrdersBulkWithHttpInfo(orders, format) {
    let postBody = null; // verify the required parameter 'orders' is set
    ...
    return this.apiClient.callApi('/orders/bulk', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get Order export
   * Export orders into a base64 encoded string
  ...
  getOrdersBulk(orders, format) {
    return this.getOrdersBulkWithHttpInfo(orders, format).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getOrdersEmailPreviewStatusWithHttpInfo(status, id) {
    let postBody = null; // verify the required parameter 'status' is set
    ...
    return this.apiClient.callApi('/orders/email-preview/{status}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get order status preview email
   * This endpoint will get a HTML email preview for an order status, this is useful if you want to be able to see what email will be sent out for the corresponding Order status.  Mailers for each order status should be stored in the getcandy config under `orders.mailers`
  ...
  getOrdersEmailPreviewStatus(status, id) {
    return this.getOrdersEmailPreviewStatusWithHttpInfo(status, id).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getOrdersIdInvoiceWithHttpInfo(orderId) {
    ...
    return this.apiClient.callApi('/orders/{orderId}/invoice', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get order invoice
   * Get an orders invoice
  ...
  getOrdersIdInvoice(orderId) {
    return this.getOrdersIdInvoiceWithHttpInfo(orderId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getOrdersIdShippingMethodsWithHttpInfo(orderId, opts) {
    ...
    return this.apiClient.callApi('/orders/{orderId}/shipping/methods', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get Order Shipping Methods
   * This will return a list of all ShippingMethod's that are available for this order.
  ...
  getOrdersIdShippingMethods(orderId, opts) {
    return this.getOrdersIdShippingMethodsWithHttpInfo(orderId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getOrdersOrderIdWithHttpInfo(orderId) {
    ...
    return this.apiClient.callApi('/orders/{orderId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get Order
   * Get an Order by it's ID.  You must be an admin or owner to retrieve the order, otherwise you'll get a 404.
  ...
  getOrdersOrderId(orderId) {
    return this.getOrdersOrderIdWithHttpInfo(orderId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getOrdersTypesWithHttpInfo() {
    ...
    return this.apiClient.callApi('/orders/types', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get order types
   * Returns all order types currently in the system
  ...
  getOrdersTypes() {
    return this.getOrdersTypesWithHttpInfo().then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postOrdersWithHttpInfo(opts) {
    ...
    let accepts = ['application/json'];
    let returnType = OrderResponse;
    return this.apiClient.callApi('/orders', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Create Order
   * Create an Order from a Basket instance
  ...
  postOrders(opts) {
    return this.postOrdersWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postOrdersBulkWithHttpInfo(opts) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/orders/bulk', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Bulk update orders
   * Allows you to bulk update a field across multiple Orders.  You must have the correct priviledges to perform this action.
  ...
  postOrdersBulk(opts) {
    return this.postOrdersBulkWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postOrdersOrderIdExpireWithHttpInfo(orderId) {
    ...
    let accepts = ['application/json'];
    let returnType = null;
    return this.apiClient.callApi('/orders/{orderId}/expire', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Expire an Order
   * Sets an order to be expired. You must have the correct priviledges to perform this action. Once an order is expired, it will no longer appear in results unless performed by an admin or in the hub.
  ...
  postOrdersOrderIdExpire(orderId) {
    return this.postOrdersOrderIdExpireWithHttpInfo(orderId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postOrdersProcessWithHttpInfo(opts) {
    ...
    let accepts = ['application/json'];
    let returnType = OrderResponse;
    return this.apiClient.callApi('/orders/process', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Processes an order on the API
   * @param {Object} opts Optional parameters
  ...
  postOrdersProcess(opts) {
    return this.postOrdersProcessWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putOrdersIdContactWithHttpInfo(orderId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject13']; // verify the required parameter 'orderId' is set
    ...
    let accepts = ['application/json'];
    let returnType = OrderResponse;
    return this.apiClient.callApi('/orders/{orderId}/contact', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Add contact details
   * Add contact details to an order
  ...
  putOrdersIdContact(orderId, opts) {
    return this.putOrdersIdContactWithHttpInfo(orderId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putOrdersIdLinesWithHttpInfo(orderId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject14']; // verify the required parameter 'orderId' is set
    ...
    let accepts = ['application/json'];
    let returnType = OrderResponse;
    return this.apiClient.callApi('/orders/{orderId}/lines', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Add order line
   * Adds an order line to an order
  ...
  putOrdersIdLines(orderId, opts) {
    return this.putOrdersIdLinesWithHttpInfo(orderId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putOrdersIdShippingAddressWithHttpInfo(orderId, opts) {
    opts = opts || {};
    let postBody = opts['address']; // verify the required parameter 'orderId' is set
    ...
    let accepts = ['application/json'];
    let returnType = OrderResponse;
    return this.apiClient.callApi('/orders/{orderId}/shipping/address', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update shipping address
   * Update an orders shipping address
  ...
  putOrdersIdShippingAddress(orderId, opts) {
    return this.putOrdersIdShippingAddressWithHttpInfo(orderId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putOrdersIdShippingCostWithHttpInfo(orderId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject12']; // verify the required parameter 'orderId' is set
    ...
    let accepts = ['application/json'];
    let returnType = OrderResponse;
    return this.apiClient.callApi('/orders/{orderId}/shipping/cost', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Add shipping cost
   * Adds a shipping cost to an Order
  ...
  putOrdersIdShippingCost(orderId, opts) {
    return this.putOrdersIdShippingCostWithHttpInfo(orderId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putOrdersOrderIdWithHttpInfo(orderId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject']; // verify the required parameter 'orderId' is set
    ...
    let accepts = ['application/json'];
    let returnType = OrderResponse;
    return this.apiClient.callApi('/orders/{orderId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update Order
   * Update an Order
  ...
  putOrdersOrderId(orderId, opts) {
    return this.putOrdersOrderIdWithHttpInfo(orderId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putOrdersOrderIdBillingAddressWithHttpInfo(orderId, opts) {
    ...
    let accepts = ['application/json'];
    let returnType = OrderResponse;
    return this.apiClient.callApi('/orders/{orderId}/billing/address', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update billing address
   * Update an orders billing address
  ...
  putOrdersOrderIdBillingAddress(orderId, opts) {
    return this.putOrdersOrderIdBillingAddressWithHttpInfo(orderId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

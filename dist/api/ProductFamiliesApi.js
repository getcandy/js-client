...
export default class ProductFamiliesApi {
  ...
  */
  ...
  deleteProductFamiliesProductFamilyIdWithHttpInfo(productFamilyId) {
    let postBody = null; // verify the required parameter 'productFamilyId' is set
    ...
    let returnType = null;
    return this.apiClient.callApi('/product-families/{productFamilyId}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Delete product family
   * Sends a request to delete a product family
  ...
  deleteProductFamiliesProductFamilyId(productFamilyId) {
    return this.deleteProductFamiliesProductFamilyIdWithHttpInfo(productFamilyId).then(function (response_and_data) {
  ...
  getProductFamiliesWithHttpInfo(opts) {
    ...
    return this.apiClient.callApi('/product-families', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get product families
   * Returns a paginated list of all product families.
  ...
  getProductFamilies(opts) {
    return this.getProductFamiliesWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getProductFamiliesProductFamilyIdWithHttpInfo(productFamilyId, opts) {
    ...
    return this.apiClient.callApi('/product-families/{productFamilyId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get a product family
   * Returns a single product family based on ID.
  ...
  getProductFamiliesProductFamilyId(productFamilyId, opts) {
    return this.getProductFamiliesProductFamilyIdWithHttpInfo(productFamilyId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postProductFamiliesWithHttpInfo() {
    ...
    let accepts = ['application/json'];
    let returnType = ProductFamilyResponse;
    return this.apiClient.callApi('/product-families', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Create product family
   * Create a new product family.
  ...
  postProductFamilies() {
    return this.postProductFamiliesWithHttpInfo().then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putProductFamiliesProductFamilyIdWithHttpInfo(productFamilyId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject27']; // verify the required parameter 'productFamilyId' is set
    ...
    let accepts = ['application/json'];
    let returnType = ProductFamilyResponse;
    return this.apiClient.callApi('/product-families/{productFamilyId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update product family
   * Update a product family
  ...
  putProductFamiliesProductFamilyId(productFamilyId, opts) {
    return this.putProductFamiliesProductFamilyIdWithHttpInfo(productFamilyId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

...
export default class ProductVariantsApi {
  ...
  */
  ...
  getProductsVariantsWithHttpInfo(opts) {
    ...
    return this.apiClient.callApi('/products/variants', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get Product Variants
   * Get a paginated list of all product variants in the system
  ...
  getProductsVariants(opts) {
    return this.getProductsVariantsWithHttpInfo(opts).then(function (response_and_data) {
  ...
  getProductsVariantsProductVariantIdWithHttpInfo(productVariantId) {
    let postBody = null; // verify the required parameter 'productVariantId' is set
    ...
    return this.apiClient.callApi('/products/variants/{productVariantId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get Product Variant
   * Get a product variant by it's ID
  ...
  getProductsVariantsProductVariantId(productVariantId) {
    return this.getProductsVariantsProductVariantIdWithHttpInfo(productVariantId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putProductsVariantsProductVariantIdInventoryWithHttpInfo(productVariantId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject16']; // verify the required parameter 'productVariantId' is set
    ...
    let accepts = ['application/json'];
    let returnType = ProductVariantResponse;
    return this.apiClient.callApi('/products/variants/{productVariantId}/inventory', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update ProductVariant Inventory
   * Request to update a product variants inventory.
  ...
  putProductsVariantsProductVariantIdInventory(productVariantId, opts) {
    return this.putProductsVariantsProductVariantIdInventoryWithHttpInfo(productVariantId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

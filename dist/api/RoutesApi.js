...
export default class RoutesApi {
  ...
  */
  ...
  getRoutesWithHttpInfo() {
    ...
    return this.apiClient.callApi('/routes', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get routes
   * Returns paginated list of routes.
  ...
  getRoutes() {
    return this.getRoutesWithHttpInfo().then(function (response_and_data) {
  ...
  getRoutesSlugWithHttpInfo(slug, opts) {
    opts = opts || {};
    let postBody = null; // verify the required parameter 'slug' is set
    ...
    return this.apiClient.callApi('/routes/{slug}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get route
   * Retrieve a route by it's slug.
  ...
  getRoutesSlug(slug, opts) {
    return this.getRoutesSlugWithHttpInfo(slug, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

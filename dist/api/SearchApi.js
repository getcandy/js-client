...
export default class SearchApi {
  ...
  */
  ...
  deleteSavedSearchesSavedSearchIdWithHttpInfo(savedSearchId) {
    let postBody = null; // verify the required parameter 'savedSearchId' is set
    ...
    let returnType = null;
    return this.apiClient.callApi('/saved-searches/{savedSearchId}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Delete saved search
   * Delete a saved search entry by ID.
  ...
  deleteSavedSearchesSavedSearchId(savedSearchId) {
    return this.deleteSavedSearchesSavedSearchIdWithHttpInfo(savedSearchId).then(function (response_and_data) {
  ...
  getSavedSearchesWithHttpInfo() {
    ...
    return this.apiClient.callApi('/saved-searches/product', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get saved searches
   * Returns a list of current saved searches for products
  ...
  getSavedSearches() {
    return this.getSavedSearchesWithHttpInfo().then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getSearchWithHttpInfo(opts) {
    ...
    return this.apiClient.callApi('/search', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Search GetCandy
   * Search across products or categories
  ...
  getSearch(opts) {
    return this.getSearchWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

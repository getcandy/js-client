...
export default class TagsApi {
  ...
  */
  ...
  deleteTagsTagIdWithHttpInfo(tagId) {
    let postBody = null; // verify the required parameter 'tagId' is set
    ...
    let returnType = null;
    return this.apiClient.callApi('/tags/{tagId}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Delete a tag
   * Deletes a tag by it's ID
  ...
  deleteTagsTagId(tagId) {
    return this.deleteTagsTagIdWithHttpInfo(tagId).then(function (response_and_data) {
  ...
  getTags() {
    return this.getTagsWithHttpInfo().then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getTagsTagIdWithHttpInfo(tagId) {
    ...
    return this.apiClient.callApi('/tags/{tagId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get a tag
   * Gets a tag by it's ID
  ...
  getTagsTagId(tagId) {
    return this.getTagsTagIdWithHttpInfo(tagId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postTags(opts) {
    return this.postTagsWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putTagsTagIdWithHttpInfo(tagId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject36']; // verify the required parameter 'tagId' is set
    ...
    let accepts = ['application/json'];
    let returnType = TagResponse;
    return this.apiClient.callApi('/tags/{tagId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update a tag
   * Updates a tag by it's ID
  ...
  putTagsTagId(tagId, opts) {
    return this.putTagsTagIdWithHttpInfo(tagId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

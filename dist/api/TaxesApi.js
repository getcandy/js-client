...
export default class TaxesApi {
  ...
  */
  ...
  deleteTaxesTaxIdWithHttpInfo(taxId) {
    let postBody = null; // verify the required parameter 'taxId' is set
    ...
    let returnType = null;
    return this.apiClient.callApi('/taxes/{taxId}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Delete tax record
   * Delete a tax record by it's ID.
  ...
  deleteTaxesTaxId(taxId) {
    return this.deleteTaxesTaxIdWithHttpInfo(taxId).then(function (response_and_data) {
  ...
  getTaxesWithHttpInfo() {
    ...
    return this.apiClient.callApi('/taxes', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get taxes
   * Get a paginated list of taxes
  ...
  getTaxesTaxIdWithHttpInfo(taxId) {
    ...
    return this.apiClient.callApi('/taxes/{taxId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get tax record
   * Get a tax record by it's ID
  ...
  getTaxesTaxId(taxId) {
    return this.getTaxesTaxIdWithHttpInfo(taxId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postTaxesWithHttpInfo(opts) {
    ...
    let accepts = ['application/json'];
    let returnType = TaxResponse;
    return this.apiClient.callApi('/taxes', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Create tax
   * Create a new tax resource.
  ...
  postTaxes(opts) {
    return this.postTaxesWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putTaxesTaxIdWithHttpInfo(taxId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject38']; // verify the required parameter 'taxId' is set
    ...
    let accepts = ['application/json'];
    let returnType = TaxResponse;
    return this.apiClient.callApi('/taxes/{taxId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Update tax record
   * Update a tax record by it's ID
  ...
  putTaxesTaxId(taxId, opts) {
    return this.putTaxesTaxIdWithHttpInfo(taxId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

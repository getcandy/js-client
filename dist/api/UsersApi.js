...
export default class UsersApi {
  ...
  */
  ...
  deleteUsersUserIdWithHttpInfo(userId) {
    let postBody = null; // verify the required parameter 'userId' is set
  ...
  deleteUsersUserId(userId) {
    return this.deleteUsersUserIdWithHttpInfo(userId).then(function (response_and_data) {
  ...
  getUsersCurrentWithHttpInfo() {
    ...
    return this.apiClient.callApi('/users/current', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Get the current user
   * Returns the user associated to the access token.
  ...
  getUsersCurrent() {
    return this.getUsersCurrentWithHttpInfo().then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  getUsersUserId(userId) {
    return this.getUsersUserIdWithHttpInfo(userId).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postAccountPasswordWithHttpInfo(opts) {
    ...
    return this.apiClient.callApi('/account/password', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
  }
  /**
   * Reset  password
   * Allows the current user to update their password.
  ...
  postAccountPassword(opts) {
    return this.postAccountPasswordWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  postUsers(opts) {
    return this.postUsersWithHttpInfo(opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  /**
  ...
  putUsersUserIdWithHttpInfo(userId, opts) {
    opts = opts || {};
    let postBody = opts['inlineObject40']; // verify the required parameter 'userId' is set
  ...
  putUsersUserId(userId, opts) {
    return this.putUsersUserIdWithHttpInfo(userId, opts).then(function (response_and_data) {
      return response_and_data.data;
    });
  }

...
export declare class RoutesApi extends BaseAPI {
     ...
     * @memberof RoutesApi
     */
    createRoute(elementType: string, elementId: number, slug: string, languageId: string, _default?: boolean, redirect?: boolean, description?: string, options?: any): Promise<import("axios").AxiosResponse<RouteResponse>>;
    /**
     * Delete a Router by its ID
     * @summary Delete Route
     * @param {string} routeId
     ...
     * @memberof RoutesApi
     */
    getRoutesSearch(slug: string, elementType: string, languageCode: string, options?: any): Promise<import("axios").AxiosResponse<RouteResponse>>;
    /**
     * Update a Route using it\'s ID
     * @summary Update Route
     * @param {string} routeId

...
export default class DiscountsApi {
    ...
    */
    ...
    deleteDiscountsDiscountId(discountId) {
      return this.deleteDiscountsDiscountIdWithHttpInfo(discountId)
     ...
     */
    getDiscounts() {
      return this.getDiscountsWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    getDiscountsDiscountId(discountId, opts) {
      return this.getDiscountsDiscountIdWithHttpInfo(discountId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    postDiscounts(opts) {
      return this.postDiscountsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    putDiscountsDiscountId(discountId, opts) {
      return this.putDiscountsDiscountIdWithHttpInfo(discountId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }

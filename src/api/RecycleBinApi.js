...
export default class RecycleBinApi {
    ...
    */
    ...
    deleteRecycleBinItemId(itemId) {
      return this.deleteRecycleBinItemIdWithHttpInfo(itemId)
     ...
     */
    getRecycleBin() {
      return this.getRecycleBinWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    getRecycleBinItemId(itemId) {
      return this.getRecycleBinItemIdWithHttpInfo(itemId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }

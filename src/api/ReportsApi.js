    ...
    */
    ...
    getProductsBestSellersWithHttpInfo(opts) {
      ...
      return this.apiClient.callApi(
        '/reports/products/best-sellers', 'GET',
    ...
    getProductsBestSellers(opts) {
      return this.getProductsBestSellersWithHttpInfo(opts)
    ...
    getReportsMetricsSubject(subject) {
      return this.getReportsMetricsSubjectWithHttpInfo(subject)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    getReportsOrders(opts) {
      return this.getReportsOrdersWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    getReportsOrdersAverages(opts) {
      return this.getReportsOrdersAveragesWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    getReportsOrdersCustomers(opts) {
      return this.getReportsOrdersCustomersWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    getReportsSales(from, opts) {
      return this.getReportsSalesWithHttpInfo(from, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }

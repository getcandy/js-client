    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('left_pos')) {
                obj['left_pos'] = ApiClient.convertToType(data['left_pos'], 'String');
            }
            if (data.hasOwnProperty('right_pos')) {
                obj['right_pos'] = ApiClient.convertToType(data['right_pos'], 'String');
            }
...
/**
 * @member {String} left_pos
 */
Category.prototype['left_pos'] = undefined;

/**
 * @member {String} right_pos
 */

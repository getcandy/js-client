...
class PaymentProviderCollection {
     ...
     */
    constructor() { 
        PaymentProviderCollectionAllOf.initialize(this);PaginatedResponse.initialize(this);
 ...
 */
PaymentProviderCollection.prototype['data'] = undefined;


// Implement PaymentProviderCollectionAllOf interface:
/**
 * @member {Array.<module:model/PaymentProvider>} data
 */

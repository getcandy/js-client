...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @GetcandyJsClient.ProductVariant();
  });
  ...
  describe('ProductVariant', function() {
    it('should create an instance of ProductVariant', function() {
      ...
      //var instane = new @GetcandyJsClient.ProductVariant();
      //expect(instance).to.be.a(@GetcandyJsClient.ProductVariant);
    });
    ...
    it('should have the property customerPricing (base name: "customer_pricing")', function() {
      // uncomment below and update the code to test the property customerPricing
      //var instane = new @GetcandyJsClient.ProductVariant();
      //expect(instance).to.be();
    });

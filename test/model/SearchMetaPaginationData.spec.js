...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GetcandyJs.SearchMetaPaginationData();
  });
  ...
  describe('SearchMetaPaginationData', function() {
    it('should create an instance of SearchMetaPaginationData', function() {
      // uncomment below and update the code to test SearchMetaPaginationData
      //var instane = new GetcandyJs.SearchMetaPaginationData();
      //expect(instance).to.be.a(GetcandyJs.SearchMetaPaginationData);
    });
